...
class Time4MindRPC:
    ...
    def call(self, method, params=None):
        ...
        resp = requests.post(self.endpoint, cert=self.cert, json=self.payload, headers=self.headers)
...
class Time4IdRPC(Time4MindRPC):
    ...
    def getTokenInfo(self,otpId,otpProvider):
        ...
        return self.call(method, params)
    def submitOOB(self,otpId,otpProvider,params):
        method = "submitOOB"
        return self.call(method, params)
    def authorizeMobile(self,otpId,otpProvider,title,sender, message,
        opType=0,authType=0,param=None):
        ...
        return self.submitOOB(otpId, otpProvider, params)
    def signMobile(self,otpId,otpProvider,title,sender, message,label,restHook=None):
        ...
        return self.authorizeMobile(otpId,otpProvider,title,sender, message,
            restHook=restHook,opType=2,authType=3,param=param)
